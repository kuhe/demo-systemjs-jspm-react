...
$__System.registerDynamic("14", ["2e", "33", "38", "39", "3a", "31", "3d", "3f", "5f", "b", "5c", "6e", "70", "73", "d", "3c", "77", "7e", "7f", "8d", "8e", "@empty", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
  ...
  function inject() {
    ...
    if ("production" !== 'production') {
      ...
      if (/[?&]react_perf\b/.test(url)) {
        var ReactDefaultPerf = $__require('@empty');
...
$__System.registerDynamic("8f", ["12", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("90", ["2f", "91", "12", "1e", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
  var GLOBAL = this;
  var EventConstants = $__require('2f');
  var ReactErrorUtils = $__require('91');
  var invariant = $__require('12');
  var warning = $__require('1e');
  var injection = {
    Mount: null,
...
$__System.registerDynamic("91", ["3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("34", ["8f", "90", "91", "80", "81", "12", "1e", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
  var GLOBAL = this;
  var EventPluginRegistry = $__require('8f');
  var EventPluginUtils = $__require('90');
  var ReactErrorUtils = $__require('91');
  var accumulateInto = $__require('80');
  var forEachAccumulated = $__require('81');
  var invariant = $__require('12');
...
$__System.registerDynamic("92", ["34", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("5e", ["2f", "34", "8f", "92", "4c", "8b", "8", "36", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
  ...
  var EventPluginHub = $__require('34');
  var EventPluginRegistry = $__require('8f');
  var ReactEventEmitterMixin = $__require('92');
  var ReactPerf = $__require('4c');
  var ViewportMetrics = $__require('8b');
  var assign = $__require('8');
  var isEventSupported = $__require('36');
...
$__System.registerDynamic("93", ["3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("e", ["93", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
  var GLOBAL = this;
  var adler32 = $__require('93');
  var TAG_END = /\/?>/;
...
$__System.registerDynamic("95", ["94", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("7c", ["95", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("96", ["5a", "1b", "c", "40", "4c", "19", "1a", "56", "60", "8", "11", "12", "57", "1e", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("98", ["12", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("56", ["99", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
  var GLOBAL = this;
  var ReactRef = $__require('99');
  function attachRefs() {
...
$__System.registerDynamic("74", ["c", "97", "56", "8", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
  var GLOBAL = this;
  var ReactElement = $__require('c');
  var ReactEmptyComponentRegistry = $__require('97');
  var ReactReconciler = $__require('56');
  var assign = $__require('8');
...
$__System.registerDynamic("10", ["96", "74", "75", "8", "12", "1e", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("3c", ["3e", "5e", "1b", "78", "c", "97", "d", "40", "e", "4c", "56", "60", "f", "8", "11", "7c", "10", "12", "62", "57", "64", "1e", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("9a", ["3c", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("27", ["1b", "6e", "14", "d", "3c", "4c", "56", "f", "15", "41", "9a", "1e", "31", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
  ...
  var ReactVersion = $__require('15');
  var findDOMNode = $__require('41');
  var renderSubtreeIntoContainer = $__require('9a');
  var warning = $__require('1e');
  ReactDefaultInjection.inject();
...
$__System.registerDynamic("9b", ["27", "3"], true, function($__require, exports, module) {
  "use strict";
  var process = $__require("3");
  var define;
  var global = this;
...
$__System.registerDynamic("9c", ["28", "9b"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var React = $__require('28');
  var ReactDOM = $__require('9b');
  module.exports = {
    React: React,
    ReactDOM: ReactDOM
  };
...
$__System.registerDynamic("9d", ["9c"], true, function($__require, exports, module) {
  ...
  var ListItem = _libJs.React.createClass({
    ...
    render: function render() {
      return _libJs.React.createElement('li', {onClick: this.click}, 'n --> ', this.state.index);
    }
  });
  var List = _libJs.React.createClass({
    ...
    render: function render() {
      ...
      return _libJs.React.createElement('ul', null, rows);
    }
  });
  module.exports = List;
  return module.exports;
...
$__System.registerDynamic("1", ["9c", "9d"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var _lib = $__require('9c');
  var React = _lib.React,
      ReactDOM = _lib.ReactDOM;
  var List = $__require('9d');
  var numbers = [],
      n = 10000;
  while (n--) {
    numbers.push(n);
  ...
  window.__react_test = function(rows) {
    ReactDOM.render(React.createElement(List, {rows: rows}), document.getElementById('main'));
  };
  console.log('hmm...');
